    ...
    <div id="MyProfile">
        ...
        <span class="SpanMyProfile">
            <?php if($sLang==='fr')
                ...
                else{echo"My name is Hervé BIROLINI, and I created this portfolio to introduce myself to you,
        ...
        <span class="SpanMyProfile">
            <?php if($sLang==='fr')
                ...
                else{echo"I took advantage of the 1st digital revolution to train myself in IT professions.
        ...
        <span class="SpanMyProfile">
            <?php if($sLang==='fr')
                ...
                else{echo"After around twenty years of experiences at all steps of program development and other
